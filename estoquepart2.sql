...
VALUES
		...
		('Armado José Santana','12345678900','armandojsantana@outlook.com','m','21/02/1971')
		,('Sheila Carvalho Leal','45678909823','scarvalho@ig.com.br','f','13/09/1973')
		...
		,('Paulo Henrique Silva','87390123111','phsilva80@hotmail.com','m','02/02/1984')
	SELECT * FROM tbCliente

INSERT INTO tbProduto (descriçãoProduto ,valorProduto, quantidadeProduto ,idFabricante, idFornecedor)
VALUES
	('Amaciante Downy', 5.76,1500 ,2,1) 
    ,('Amaciante Comfort' ,5.45,2300,1, 1)
	,('Sabão em pó OMO' ,5.99 ,1280 ,1, 2)
	,('Margarida Qually' ,4.75, 2500,3,1)
...
INSERT INTO tbItensVenda (idCliente, idProduto, quantidadeItensVenda, subTotalItensVenda)
VALUES
	(1,1,200,1500.00)
	,(1,2,300,3000.00)
	,(2,4,120,1400.00)
